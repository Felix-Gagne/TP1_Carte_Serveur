        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Poisoned = table.Column<bool>(type: "INTEGER", nullable: false),
                    PoisonedLevel = table.Column<int>(type: "INTEGER", nullable: false),
                    Stuned = table.Column<bool>(type: "INTEGER", nullable: false),
                    StunTurnLeft = table.Column<int>(type: "INTEGER", nullable: false),
                    QuickPlayCard = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "11111111-1111-1111-1111-111111111111", 0, "60f771c7-c151-4c6b-9e10-b2a240d8deba", "admin@admin.com", true, false, null, "ADMIN@ADMIN.COM", "ADMIN@ADMIN.COM", "AQAAAAIAAYagAAAAELEJu/zr27xNmDzonoeFeNGrO/5nW11QDFpKKZ4ZbbaieCTpsL5jN1E7WCbzuZgFjw==", null, false, "592012b1-acdb-4c49-8cb3-0b2f5f8083d7", false, "admin@admin.com" });
